...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \section{Manim} % creates a section
    ...
    \section{Eine einzelne Kachel} % creates a section
    ...
    \section{Die drei Datentypen in Python} % creates a section
    ...
    \section{Meine Umrandungs-Funktion} % creates a section
    ...
    \section{Konstante Variablen in meinem Programm} % creates a section
